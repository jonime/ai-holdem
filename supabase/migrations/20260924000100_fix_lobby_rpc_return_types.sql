...
grant execute on function public.start_game_if_version(uuid, bigint, jsonb, integer, integer)
  to service_role;
revoke all on function public.start_next_hand_if_version(uuid, bigint, jsonb, integer, integer)
  from public, anon, authenticated;
grant execute on function public.start_next_hand_if_version(uuid, bigint, jsonb, integer, integer)
  to service_role;
